...
const WeatherDisplay = ({ className = "" }) => {
  return (
    <section
      className={`w-[396px] !!m-[0 important] absolute top-[141px] right-[100px] rounded-[40px] bg-dodgerblue-100 flex flex-col items-start pt-num-36 pb-[35px] pl-[38px] pr-num-32 box-border gap-[23px] max-w-full h-auto [transform:rotate(0deg)] z-[4] text-left text-num-14 text-white font-inter hover:bg-dodgerblue-100 hover:flex hover:w-[396px] hover:h-auto hover:flex-col hover:gap-[23px] hover:items-start hover:justify-start hover:[transform:rotate(0deg)] hover:rounded-[40px] hover:pt-num-36 hover:pb-[35px] hover:pl-[38px] hover:pr-num-32 hover:box-border hover:max-w-full ${className}`}
    >
      <div className="self-stretch flex flex-col items-start gap-[27px] w-full h-auto [transform:rotate(0deg)] shrink-0 hover:flex hover:self-stretch hover:w-full hover:h-auto hover:flex-col hover:gap-[27px] hover:items-start hover:justify-start hover:[transform:rotate(0deg)]">
        <div className="self-stretch flex flex-col items-start gap-[18px] w-full h-auto [transform:rotate(0deg)] hover:flex hover:self-stretch hover:w-full hover:h-auto hover:flex-col hover:gap-[18px] hover:items-start hover:justify-start hover:[transform:rotate(0deg)]">
          <div className="self-stretch flex items-start justify-between gap-5 w-full h-auto [transform:rotate(0deg)] hover:flex hover:self-stretch hover:w-full hover:h-auto hover:flex-row hover:gap-5 hover:items-start hover:justify-between hover:[transform:rotate(0deg)] mq450:flex-wrap mq450:gap-5">
            <div className="w-num-241 flex flex-col items-start pt-num-7 px-num-0 pb-num-0 box-border h-auto gap-0 [transform:rotate(0deg)] hover:flex hover:w-num-241 hover:h-auto hover:flex-col hover:gap-0 hover:items-start hover:justify-start hover:[transform:rotate(0deg)] hover:pt-num-7 hover:px-num-0 hover:pb-num-0 hover:box-border">
              <b className="self-stretch relative block font-bold w-full h-auto z-[5] hover:font-bold hover:font-inter hover:text-num-14 hover:text-left hover:text-white hover:block hover:self-stretch hover:w-full hover:h-auto">
                CURRENT CONDITIONS
              </b>
            </div>
            <img
              className="cursor-pointer border-orange border-solid border-[2px] p-num-0 bg-[transparent] h-num-30 w-[30px] relative block box-border z-[5] hover:block hover:w-[30px] hover:h-num-30 hover:border-orange hover:border-solid hover:hover:border-[2px] hover:box-border"
              alt=""
              src="/Title-Separator.svg"
            />
          </div>
        ...
        <div className="w-num-241 h-num-58 relative block gap-0 items-start [transform:rotate(0deg)] text-num-48 hover:block hover:w-num-241 hover:h-num-58 hover:gap-0 hover:items-start hover:justify-start hover:[transform:rotate(0deg)]">
          ...
          <img
            className="cursor-pointer [border:none] p-num-0 bg-[transparent] absolute top-[5px] left-[58px] w-6 h-6 block gap-0 z-[6] hover:block hover:w-6 hover:h-6 hover:gap-0"
            alt=""
            src="/lucide-thermometer.svg"
          />
        </div>
      </div>
      <div className="self-stretch rounded-[30px] bg-gainsboro-400 flex flex-col items-start pt-5 pb-[59px] pl-num-55 pr-5 box-border gap-[13px] max-w-full w-full h-auto [transform:rotate(0deg)] z-[5] shrink-0 text-num-11 hover:bg-gainsboro-400 hover:flex hover:self-stretch hover:w-full hover:h-auto hover:flex-col hover:gap-[13px] hover:items-start hover:justify-start hover:[transform:rotate(0deg)] hover:rounded-[30px] hover:pt-5 hover:pb-[59px] hover:pl-num-55 hover:pr-5 hover:box-border hover:max-w-full">
